...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\hp\Documents\portal\Locker\private\progamming\python\environment\classification_dry_bean'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\hp\Documents\portal\Locker\private\progamming\python\environment\classification_dry_bean\Scripts\deactivate.nu'
